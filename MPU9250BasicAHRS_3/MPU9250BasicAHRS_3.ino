...
/* Variavles definitions */
long double list[10] = {0};
byte cnt = 0;
...
void setup()
{
  ...
  if (c == 0x73) // WHO_AM_I should always be 0x68
  {
    ...
    if (SerialDebug)Serial.println("AK8963 initialized for active data mode....");
    if (SerialDebug)
    {
...
void loop()
{
  ...
  else
  {
    ...
    if (myIMU.delt_t > intervaltime)
    {
      ...
      /***************************** ADD ******************************************/
      double vectornorm = norm((double)myIMU.mx, (double)myIMU.my, (double)myIMU.mz);
      double vectornormxy = norm((double)myIMU.mx, (double)myIMU.my, 0);
      if (cnt == 10) {
        cnt = 0;
        long double sum = 0;
        double average = 0.0;
        ...
        average = sum / 10.0;
        //Serial.print(" Ave theta = "); Serial.println(average,4);
      }
      ...
      *****/
      if (SerialDebug)
      {
        ...
        /*
          ...
          Serial.print(" my = "); Serial.print( (myIMU.my/vectornorm) );
          Serial.print(" mz = "); Serial.print( (myIMU.mz/vectornorm) );
          Serial.println(" mG");
        */
        ...
        /*
          Serial.print("mx = "); Serial.print( (myIMU.mx/vectornormxy) );
          Serial.print(" my = "); Serial.print( (myIMU.my/vectornormxy) );
        */
        /*
